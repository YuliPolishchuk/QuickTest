...
const CreateLoadSprint = ({navigation}) => {
  ...
  // Reset Dropdowns Messages

  const [channelSelectMessage, setChannelSelectMessage] = useState('');
  const [languageSelectMessage, setLanguageSelectMessage] = useState('');
  const [serviceSelectMessage, setServiceSelectMessage] = useState('');
  const [scriptSelectMessage, setScriptSelectMessage] = useState('');
  const [
            ...
            <TouchableOpacity
              onPress={() => {
                if (numberOfCalls == '') {
                  ...
                  setLanguageSelectMessage('Select Language');
                  setServiceSelectMessage('Select Service');
                  setScriptSelectMessage('Select Script');
                  setErrorMessageForChannelDetails('');
                }
              }}>
              <Iconn
          ...
          <FlatList
            ...
            renderItem={({item, index}) => {
              return (
                <LoadSprintCard
                  item={item}
                  deleteFromFlatlist={deleteFromExpectedInputArray}
                  index={index}
...
export default withNavigation(CreateLoadSprint);
