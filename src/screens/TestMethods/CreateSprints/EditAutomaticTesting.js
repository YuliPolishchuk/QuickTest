...
const EditAutomaticTesting = ({navigation}) => {
         ...
         <Text style={[TestMethod.TestMethodFormHeadings]}>
          ...
          <Button
            onPress={() => {
              ...
              } else if (selectedTestType == 'Scheduled Testing') {
                if (email == '') {
...
export default withNavigation(EditAutomaticTesting);
